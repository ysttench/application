...
import com.ysttench.application.center.settings.common.TreeUtil;
import com.ysttench.application.center.settings.kernel.entity.SysMenuFormMap;
import com.ysttench.application.center.settings.kernel.mapper.SysMenuMapper;
...
import com.ysttench.application.center.settings.web.rdto.util.MenuTreeObject;
import com.ysttench.application.center.settings.web.rdto.util.MenuTreeObjectUtil;
import com.ysttench.application.center.settings.web.rdto.util.Params;
...
public class SysMenuController extends BaseController {
    ...
    public String editUI(Model model) {
        ...
        if (StringUtil.isNotEmpty(id)) {
        	...
        	sysMenuFormMap.put("menuId", id);
        	model.addAttribute("menu",sysMenuMapper.findByWhere(sysMenuFormMap).get(0));
    ...
    public String deleteEntity(Model model) throws Exception {
        ...
        for (String id : ids1) {
            sysMenuMapper.deleteByAttribute(id);
        }
        return AttrConstants.SUCCESS;
    }
