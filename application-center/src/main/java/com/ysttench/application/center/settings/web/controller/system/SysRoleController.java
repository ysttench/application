...
import com.ysttench.application.center.settings.kernel.entity.SysRoleFormMap;
import com.ysttench.application.center.settings.kernel.entity.SysUserFormMap;
import com.ysttench.application.center.settings.kernel.mapper.SysRoleMapper;
...
public class SysRoleController extends BaseController {
    ...
    public PageView findByPage(String pageNow, String pageSize, String column, String sort) throws Exception {
        ...
        sysRoleFormMap.put("pageNow", pageNow);
        sysRoleFormMap.put("pageSize", pageSize);
    ...
    public String deleteEntity() throws Exception {
        ...
        for (String id : ids1) {
        	...
        	sysRoleFormMap.put("roleId", id);
        	sysRoleMapper.deleteByAttribute(sysRoleFormMap);
        }
        return AttrConstants.SUCCESS;
    }
    ...
    public String editUI(Model model) throws Exception {
        ...
        if (StringUtil.isNotEmpty(id)) {
        	SysRoleFormMap sysRoleFormMap = new SysRoleFormMap();
        	sysRoleFormMap.put("roleId", id);
            model.addAttribute("role", sysRoleMapper.findbyFrist(sysRoleFormMap));
        }
    ...
    public String seletRole(Model model) throws Exception {
        ...
        if (null != userId) {
            ...
            if (StringUtils.isNotBlank(ugid)) {
                //sysRoleFormMap.put("roleId", "  ROLE_ID not in (" + ugid + ") AND STATE = 0");
            	sysRoleFormMap.put("roleId", ugid);
            }
