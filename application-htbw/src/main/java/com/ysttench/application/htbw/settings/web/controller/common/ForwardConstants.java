...
public class ForwardConstants {
	...
	public static final String CKEQUIP = "/ckequip";
	public static final String SPARE = "/spare";
	public static final String SPARE_SELECT = "/spare_select";
	public static final String SPARELIST = "/sparelist";
	public static final String UNIT = "/unit";
	public static final String SPARE_EDIT = "/spare_edit";
	public static final String GAINLIST = "/gainlist";
	public static final String MNTENCELIST = "/mntencelist";
	public static final String EXCEPTLIST = "/exceptlist";
	public static final String EXCEL = "/excel";
	public static final String SYSTEMSG = "/systemsg";
	public static final String REGIONAL = "/regional";
	public static final String EQUIPTYPE = "/equiptype";
	public static final String SUPPLIER = "/supplier";
	public static final String NOTICE = "/notice";
	public static final String SUCCESSION = "/succession";
	public static final String WARNLIMIT = "/warnlimit";
	public static final String WARNMSG = "/warnmsg";
	public static final String LOGRECORD = "/logrecord";
	public static final String EQUIPOINT = "/equipoint";
	public static final String MODBUSPOINT = "/modbuspoint";
	public static final String TEMPER = "/temper";
	public static final String HUM = "/hum";
	public static final String ANNOUNT = "/annount";
