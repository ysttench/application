...
import com.ysttench.application.htdytasties.settings.kernel.entity.RegionalFormMap;
import com.ysttench.application.htdytasties.settings.kernel.mapper.RegionalMapper;
...
public class RegionalController extends BaseController {
	...
	return ForwardConstants.SYSTEM + ForwardConstants.REGIONAL + ForwardConstants.LIST;
	...
	return ForwardConstants.SYSTEM + ForwardConstants.REGIONAL + ForwardConstants.ADD;
    }
	...
	for (String id : ids1) {
		...
		map.put("parentId", id);
		regionalMapper.editeEntity(map);
	    }
	...
	return ForwardConstants.SYSTEM + ForwardConstants.REGIONAL + ForwardConstants.EDIT;
    }
