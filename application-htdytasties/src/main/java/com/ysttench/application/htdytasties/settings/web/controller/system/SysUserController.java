...
import com.ysttench.application.htdytasties.settings.kernel.entity.SysUserRoleFormMap;
import com.ysttench.application.htdytasties.settings.kernel.mapper.SysUserMapper;
import com.ysttench.application.htdytasties.settings.kernel.mapper.SysUserRoleMapper;
...
import com.ysttench.application.htdytasties.settings.web.rdto.system.SysUserBean;
...
public class SysUserController extends BaseController {
    ...
    public PageView findByPage(String pageNow, String pageSize, String column, String sort) throws Exception {
        ...
        SysRoleFormMap role = sysUserMapper.findbyFrist("roleId", "1", SysRoleFormMap.class);
