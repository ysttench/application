package com.ysttench.application.htdytasties.settings.web.controller.index;
...
import com.ysttench.application.htdytasties.settings.common.TreeUtil;
import com.ysttench.application.htdytasties.settings.kernel.entity.LogUserLoginFormMap;
...
import com.ysttench.application.htdytasties.settings.kernel.mapper.LogUserLoginMapper;
import com.ysttench.application.htdytasties.settings.kernel.mapper.SysMenuMapper;
import com.ysttench.application.htdytasties.settings.kernel.mapper.SysSystemMapper;
import com.ysttench.application.htdytasties.settings.kernel.mapper.SysUserMapper;
...
import com.ysttench.application.htdytasties.settings.web.rdto.util.MenuTreeObject;
import com.ysttench.application.htdytasties.settings.web.rdto.util.MenuTreeObjectUtil;
...
public class BackgroundController extends BaseController {
	...
	model.addAttribute("system", sysSystemMapper.findbyFrist("id", "1", SysSystemForMap.class));
		...
		if (tempUserFormMap.containsKey(pass) && tempUserFormMap.getStr(pass) != null) {
