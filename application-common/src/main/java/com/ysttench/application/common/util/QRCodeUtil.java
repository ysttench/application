...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String fileName = "aaaaaaaaa";
        QRCodeUtil.encode(text, "d:/MyWorkDoc/b.jpg", "d:/MyWorkDoc", true, fileName);
        // String text = "测试的二维码 .dididididi";
        // QRCodeUtil.encode(text,"","d:/MyWorkDoc",true);
        System.out.println("生成图片耗时：" + String.valueOf(System.currentTimeMillis() - now_time) + "ms");
