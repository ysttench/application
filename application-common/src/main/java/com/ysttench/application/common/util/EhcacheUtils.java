...
public class EhcacheUtils {
    ...
    public static boolean OVER_FLOW_TO_DISK = true;
    ...
    public static String MEMORY_STOREE_VICTION_POLICY = "LFU";
    ...
    public static Cache initCache(String cacheName, int maxElementsInMemory, boolean overflowToDisk,
            boolean eternal, long timeToLiveSeconds, long timeToIdleSeconds) throws Exception {
        try {
    ...
    public static Cache initCache(String cacheName, long timeToLiveSeconds) throws Exception {
        return EhcacheUtils.initCache(cacheName, MAX_ELEMENTS_IN_MEMORY, OVER_FLOW_TO_DISK, ETERNAL,
                timeToLiveSeconds, TIME_TO_IDLE_SECONDS);
    }
    ...
    public static boolean setValue(String cacheName, String key, Object value, Integer timeToLiveSeconds)
        ...
        try {
            ...
            myCache.put(new Element(key, value, ETERNAL, TIME_TO_IDLE_SECONDS, timeToLiveSeconds));
            return true;
        } catch (Exception e) {
            throw new Exception("set cache " + cacheName + " failed!!!");
        }
