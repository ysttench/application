 ...
 */
package com.ysttench.application.common.modbus4j;
...
import com.ysttench.application.common.modbus4j.base.KeyedModbusLocator;
import com.ysttench.application.common.modbus4j.base.ReadFunctionGroup;
import com.ysttench.application.common.modbus4j.base.SlaveProfile;
import com.ysttench.application.common.modbus4j.code.DataType;
import com.ysttench.application.common.modbus4j.code.ExceptionCode;
import com.ysttench.application.common.modbus4j.code.FunctionCode;
import com.ysttench.application.common.modbus4j.code.RegisterRange;
import com.ysttench.application.common.modbus4j.exception.ErrorResponseException;
import com.ysttench.application.common.modbus4j.exception.InvalidDataConversionException;
...
import com.ysttench.application.common.modbus4j.locator.BaseLocator;
import com.ysttench.application.common.modbus4j.locator.BinaryLocator;
import com.ysttench.application.common.modbus4j.locator.NumericLocator;
import com.ysttench.application.common.modbus4j.msg.ModbusRequest;
import com.ysttench.application.common.modbus4j.msg.ModbusResponse;
import com.ysttench.application.common.modbus4j.msg.ReadCoilsRequest;
import com.ysttench.application.common.modbus4j.msg.ReadDiscreteInputsRequest;
import com.ysttench.application.common.modbus4j.msg.ReadHoldingRegistersRequest;
import com.ysttench.application.common.modbus4j.msg.ReadInputRegistersRequest;
import com.ysttench.application.common.modbus4j.msg.ReadResponse;
import com.ysttench.application.common.modbus4j.msg.WriteCoilRequest;
import com.ysttench.application.common.modbus4j.msg.WriteCoilsRequest;
import com.ysttench.application.common.modbus4j.msg.WriteMaskRegisterRequest;
import com.ysttench.application.common.modbus4j.msg.WriteRegisterRequest;
import com.ysttench.application.common.modbus4j.msg.WriteRegistersRequest;
import com.ysttench.application.common.modbus4j.sero.epoll.InputStreamEPollWrapper;
import com.ysttench.application.common.modbus4j.sero.messaging.MessageControl;
import com.ysttench.application.common.modbus4j.sero.util.ArrayUtils;
import com.ysttench.application.common.modbus4j.sero.util.ProgressiveTask;


abstract public class ModbusMaster extends Modbus {
    private int timeout = 500;
    private int retries = 2;
    private Object ModbusMasterObj;
    

    

    public Object getModbusMasterObj() {
        return ModbusMasterObj;
    }

    public void setModbusMasterObj(Object modbusMasterObj) {
